...
// Static data for weekly trend (could be dynamic in future)
const weeklyData = [
  { name: 'Mon', score: 75 },
  { name: 'Tue', score: 82 },
  { name: 'Wed', score: 68 },
...
const DashboardHome: React.FC = () => {
  ...
  const pieColors = theme === 'dark' 
    ? ['#8b5cf6', '#1e293b'] // Purple-500 & Slate-800
    : ['#6366f1', '#e2e8f0']; // Indigo-500 & Slate-200
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Card 1: Sleep Score (Donut Chart) */}
        <motion.div 
